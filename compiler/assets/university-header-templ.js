...
(function() {
	...
	var ucfhbInitialize = function() {
        ...
        linkLibrary       = document.getElementById('ucfhb-library'),
      ...
      ucfhbAssignTrackingListener(linkLibrary, 'click', linkLibrary.getAttribute('href'), ucfhbTrackingActionSignon, 'Library');
